...
if category == "Length":
    ...
    unit = st.selectbox("⚖️ Select Converter", ["Kilogram to Gram","Gram to Milligram","Pound to Ounce","Pound to Miligram","Pound to Stone","Ounce to Kilogram","Gram to Microgram"])
elif category == "Time":
